...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-open:animate-accordion-down data-closed:animate-accordion-up text-base leading-relaxed overflow-hidden"
      {...props}
    >
      <div
        className={cn(
